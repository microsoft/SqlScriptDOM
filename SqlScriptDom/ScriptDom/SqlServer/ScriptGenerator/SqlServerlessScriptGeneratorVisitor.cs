//------------------------------------------------------------------------------
// <copyright file="SqlServerlessScriptGeneratorVisitor.cs" company="Microsoft">
...
{
    internal class SqlServerlessScriptGeneratorVisitor : SqlScriptGeneratorVisitor
    {
        public SqlServerlessScriptGeneratorVisitor(SqlScriptGeneratorOptions options, ScriptWriter writer)
            : base(options, writer)
        {
