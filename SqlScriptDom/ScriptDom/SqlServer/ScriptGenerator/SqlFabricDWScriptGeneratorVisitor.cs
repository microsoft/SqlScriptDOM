//------------------------------------------------------------------------------
// <copyright file="SqlFabricDWSqlScriptGeneratorVisitor.cs" company="Microsoft">
...
{
    internal class SqlFabricDWScriptGeneratorVisitor : SqlScriptGeneratorVisitor
    {
        public SqlFabricDWScriptGeneratorVisitor(SqlScriptGeneratorOptions options, ScriptWriter writer)
            : base(options, writer)
        {
