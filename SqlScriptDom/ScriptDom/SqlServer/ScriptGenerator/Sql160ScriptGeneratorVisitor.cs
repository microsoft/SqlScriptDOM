//------------------------------------------------------------------------------
// <copyright file="Sql160SqlScriptGeneratorVisitor.cs" company="Microsoft">
...
{
    internal class Sql160ScriptGeneratorVisitor : SqlScriptGeneratorVisitor
    {
        public Sql160ScriptGeneratorVisitor(SqlScriptGeneratorOptions options, ScriptWriter writer)
            : base(options, writer)
        {
