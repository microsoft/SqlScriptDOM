//------------------------------------------------------------------------------
// <copyright file="Sql170SqlScriptGeneratorVisitor.cs" company="Microsoft">
...
{
    internal class Sql170ScriptGeneratorVisitor : SqlScriptGeneratorVisitor
    {
        public Sql170ScriptGeneratorVisitor(SqlScriptGeneratorOptions options, ScriptWriter writer)
            : base(options, writer)
        {
