//------------------------------------------------------------------------------
// <copyright file="TSql140Parser.cs" company="Microsoft">
...
namespace Microsoft.SqlServer.TransactSql.ScriptDom
{
    ...
    /// </summary>
    [Serializable]
    public class TSql140Parser : TSqlParser
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TSql140Parser"/> class.
        /// </summary>
        ...
        TSql140ParserInternal GetNewInternalParser()
        {
            return new TSql140ParserInternal(QuotedIdentifier);
        }

        TSql140ParserInternal GetNewInternalParserForInput(TextReader input, out IList<ParseError> errors, 
            int startOffset, int startLine, int startColumn)
        {
            TSql140ParserInternal parser = GetNewInternalParser();
        ...
        public override TSqlFragment Parse(IList<TSqlParserToken> tokens, out IList<ParseError> errors)
        {
            ...
            if (result != null)
            {
                VersioningVisitor versioningVisitor = new VersioningVisitor(engineType, SqlVersion.Sql140);
        ...
        {
            TSql140ParserInternal parser = GetNewInternalParserForInput(input, out errors, startOffset, startLine, startColumn);
