//------------------------------------------------------------------------------
// <copyright file="TSqlFabricDWParser.cs" company="Microsoft">
...
{
    /// <summary>
    /// The TSql Parser for Fabric Data Warehouse.
    /// </summary>
    [Serializable]
    public class TSqlFabricDWParser : TSqlParser
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TSqlFabricDWParser"/> class.
        /// </summary>
        /// <param name="initialQuotedIdentifiers">if set to <c>true</c> [initial quoted identifiers].</param>
        public TSqlFabricDWParser(bool initialQuotedIdentifiers)
        ...
        public TSqlFabricDWParser(bool initialQuotedIdentifiers, SqlEngineType engineType)
            : base(initialQuotedIdentifiers)
        {
        ...
        {
            return new TSqlFabricDWLexerInternal();
        }

        #region Some utility stuff
        TSqlFabricDWParserInternal GetNewInternalParser()
        {
            return new TSqlFabricDWParserInternal(QuotedIdentifier);
        }

        TSqlFabricDWParserInternal GetNewInternalParserForInput(TextReader input, out IList<ParseError> errors, 
            int startOffset, int startLine, int startColumn)
        {
            TSqlFabricDWParserInternal parser = GetNewInternalParser();
        ...
        public override TSqlFragment Parse(IList<TSqlParserToken> tokens, out IList<ParseError> errors)
        {
            ...
            if (result != null)
            {
                VersioningVisitor versioningVisitor = new VersioningVisitor(engineType, SqlVersion.SqlFabricDW);
        ...
        {
            TSqlFabricDWParserInternal parser = GetNewInternalParserForInput(input, out errors, startOffset, startLine, startColumn);
