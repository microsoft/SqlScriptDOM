//------------------------------------------------------------------------------
// <copyright file="TSql110Parser.cs" company="Microsoft">
...
namespace Microsoft.SqlServer.TransactSql.ScriptDom
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TSql110Parser"/> class.
        /// </summary>
        ...
        TSql110ParserInternal GetNewInternalParser()
        {
            return new TSql110ParserInternal(QuotedIdentifier);
        }

        TSql110ParserInternal GetNewInternalParserForInput(TextReader input, out IList<ParseError> errors, 
            int startOffset, int startLine, int startColumn)
        {
            TSql110ParserInternal parser = GetNewInternalParser();
        ...
        {
            TSql110ParserInternal parser = GetNewInternalParserForInput(input, out errors, startOffset, startLine, startColumn);
