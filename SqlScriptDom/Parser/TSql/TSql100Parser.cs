//------------------------------------------------------------------------------
// <copyright file="TSql100Parser.cs" company="Microsoft">
...
namespace Microsoft.SqlServer.TransactSql.ScriptDom
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TSql100Parser"/> class.
        /// </summary>
        ...
        TSql100ParserInternal GetNewInternalParser()
        {
            return new TSql100ParserInternal(QuotedIdentifier);
        }

        TSql100ParserInternal GetNewInternalParserForInput(TextReader input, out IList<ParseError> errors, 
            int startOffset, int startLine, int startColumn)
        {
            TSql100ParserInternal parser = GetNewInternalParser();
        ...
        {
            TSql100ParserInternal parser = GetNewInternalParserForInput(input, out errors, startOffset, startLine, startColumn);
