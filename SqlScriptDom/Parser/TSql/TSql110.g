//------------------------------------------------------------------------------
// <copyright file="TSql110.g" company="Microsoft">
...
class TSql110ParserInternal extends Parser("TSql110ParserBaseInternal");
options {
    k = 2;
            ...
            (tUpdatabilityOption:Identifier 
                {
                    ...
                    vResult.UpdatabilityOption = ModifyFilegroupOptionsHelper.Instance.ParseOption(tUpdatabilityOption, SqlVersionFlags.TSql110);
...
dbSingleIdentOption returns [DatabaseOption vResult = FragmentFactory.CreateFragment<DatabaseOption>()]
    : tOption:Identifier
        {
            vResult.OptionKind = SimpleDbOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
            UpdateTokenInfo(vResult,tOption);
        }
    ;
...
alterDbOnOffOption returns [OnOffDatabaseOption vResult = FragmentFactory.CreateFragment<OnOffDatabaseOption>()]
{
    ...
    : tOption:Identifier vOptionState = optionOnOff[vResult]
        {
            vResult.OptionKind = OnOffSimpleDbOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
...
azureMaxSizeDatabaseOption returns [MaxSizeDatabaseOption vResult = FragmentFactory.CreateFragment<MaxSizeDatabaseOption>()]
{
    ...
    : tMaxSize:Identifier EqualsSign vSize=integer tGB:Identifier
        {
            ...
            Match(tGB, CodeGenerationSupporter.GB);
            vResult.Units=MemoryUnit.GB;
            UpdateTokenInfo(vResult, tGB);
        }
    ;
...
databaseAuditActionGroup returns [AuditActionGroupReference vResult = FragmentFactory.CreateFragment<AuditActionGroupReference>()]
    :
        ...
        {
            vResult.Group = DatabaseAuditActionGroupHelper.Instance.ParseOption(tDatabaseAuditActionGroup, SqlVersionFlags.TSql110);
...
serverAuditActionGroup returns [AuditActionGroupReference vResult = FragmentFactory.CreateFragment<AuditActionGroupReference>()]
    :
        ...
        {
            vResult.Group = ServerAuditActionGroupHelper.Instance.ParseOption(tServerAuditActionGroup, SqlVersionFlags.TSql110);
...
backupOption returns [BackupOption vResult = FragmentFactory.CreateFragment<BackupOption>()]
{
    ...
    : tSimpleOption:Identifier
        {
            ...
            vResult.OptionKind = BackupOptionsNoValueHelper.Instance.ParseOption(tSimpleOption, SqlVersionFlags.TSql110);
    ...
    | (tOption:Identifier EqualsSign 
        ...
        {
            vResult.OptionKind = BackupOptionsWithValueHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
            vResult.Value = vValue;
        }
      )
    ;
...
simpleRestoreOption returns [RestoreOption vResult = FragmentFactory.CreateFragment<RestoreOption>()]
    : tOption:Identifier
        {
            vResult.OptionKind = RestoreOptionNoValueHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
            UpdateTokenInfo(vResult,tOption);
        }
    ;
...
dbccOption returns [DbccOption vResult=FragmentFactory.CreateFragment<DbccOption>()]
    :     tOption:Identifier 
        {
            vResult.OptionKind= DbccOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
            UpdateTokenInfo(vResult, tOption);
        }
    ;
...
eventTypeGroupContainer returns [EventTypeGroupContainer vResult = null]
    : 
        tIdentifier:Identifier
        {
            ...
            if (TriggerEventTypeHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql110, out eventTypeValue))
            {
                vResult = CreateEventTypeContainer(eventTypeValue, tIdentifier);
            }
            else if (AuditEventTypeHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql110, out eventTypeValue))
            {
                vResult = CreateEventTypeContainer(eventTypeValue, tIdentifier);
            }
            else if (TriggerEventGroupHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql110, out eventGroupValue))
            {
                vResult = CreateEventGroupContainer(eventGroupValue, tIdentifier);
            }
            else
            {
                eventGroupValue = AuditEventGroupHelper.Instance.ParseOption(tIdentifier, SqlVersionFlags.TSql110);
                vResult = CreateEventGroupContainer(eventGroupValue, tIdentifier);
            }
        }
    ;
...
alterIndexStatement returns [AlterIndexStatement vResult = this.FragmentFactory.CreateFragment<AlterIndexStatement>()]
{
    ...
    : Index 
        ...
        |
            ...
            {
                vResult.AlterIndexType = AlterIndexTypeHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
                UpdateTokenInfo(vResult,tOption);
            }
            (
...
identifierAlterUserOption[IToken tOption] returns [IdentifierPrincipalOption vResult = FragmentFactory.CreateFragment<IdentifierPrincipalOption>()]
{
    ...
    :   vIdentifier=identifier
        {
            vResult.OptionKind = UserOptionHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
            vResult.Identifier = vIdentifier;
            UpdateTokenInfo(vResult, tOption);
        }
    ;
...
predicateSetStatement returns [PredicateSetStatement vResult = this.FragmentFactory.CreateFragment<PredicateSetStatement>()]
{
    ...
    : tOption:Identifier 
        {
            option = PredicateSetOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
                
            vResult.Options = option;
        }
        (Comma tOption2:Identifier
            {
                option = PredicateSetOptionsHelper.Instance.ParseOption(tOption2, SqlVersionFlags.TSql110);
...
setStatisticsStatement returns [SetStatisticsStatement vResult = FragmentFactory.CreateFragment<SetStatisticsStatement>()]
    : Statistics tStatOption:Identifier 
        {
            vResult.Options = SetStatisticsOptionsHelper.Instance.ParseOption(tStatOption, SqlVersionFlags.TSql110);
        }
        (Comma tStatOption2:Identifier
            {
                vResult.Options |= SetStatisticsOptionsHelper.Instance.ParseOption(tStatOption2, SqlVersionFlags.TSql110);
            }
        )* 
        setOnOff[vResult]
    ;
...
indexStateOption returns [IndexStateOption vResult = FragmentFactory.CreateFragment<IndexStateOption>()]
{
    ...
    :    tOption:Identifier 
        {
            vResult.OptionKind = IndexOptionHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql110);
            UpdateTokenInfo(vResult, tOption);
        }
        EqualsSign vOptionState=optionOnOff[vResult]
        {
...
simpleTableHint returns [TableHint vResult = FragmentFactory.CreateFragment<TableHint>()]
    ...
    |   tId:Identifier
        {
            vResult.HintKind = TableHintOptionsHelper.Instance.ParseOption(tId, SqlVersionFlags.TSql110);
            UpdateTokenInfo(vResult,tId);
        }
    ;
...
simpleOptimizerHint returns [OptimizerHint vResult = FragmentFactory.CreateFragment<OptimizerHint>()]
    ...
    | tMonoHint:Identifier
        {
            vResult.HintKind = MonoOptimizerHintHelper.Instance.ParseOption(tMonoHint, SqlVersionFlags.TSql110);
...
literalOptimizerHint returns [LiteralOptimizerHint vResult = FragmentFactory.CreateFragment<LiteralOptimizerHint>()]
{
    ...
    : tIntegerHint:Identifier vValue = integer
        {
            vResult.HintKind = IntegerOptimizerHintHelper.Instance.ParseOption(tIntegerHint, SqlVersionFlags.TSql110);
            vResult.Value = vValue;
        }
    ;
...
resourcePoolParameter returns [ResourcePoolParameter vResult = this.FragmentFactory.CreateFragment<ResourcePoolParameter>()]
{
	...
	ResourcePoolAffinitySpecification vAffinitySpec;
        ...
        |
            tPercent:Identifier 
            {
                vResult.ParameterType = ResourcePoolParameterHelper.Instance.ParseOption(tPercent, SqlVersionFlags.TSql110);
            }
            ...
            tParameter:Identifier EqualsSign 
                ...
                |
                    vParameter=integer
                    {
                        ...
                        workloadGroupResource.ParameterType = WorkloadGroupResourceParameterHelper.Instance.ParseOption(tParameter, SqlVersionFlags.TSql110);
                        Int32 value;
...
spatialIndexingScheme [CreateSpatialIndexStatement vParent]
    :    tUsing:Identifier 
        ...
        {
            vParent.SpatialIndexingScheme = SpatialIndexingSchemeTypeHelper.Instance.ParseOption(tIndexingScheme, SqlVersionFlags.TSql110);
...
spatialIndexRegularOption [IndexAffectingStatement statement] returns [SpatialIndexRegularOption vResult = this.FragmentFactory.CreateFragment<SpatialIndexRegularOption>()]
{
    ...
    :    (
            ...
            {
                VerifyAllowedIndexOption(statement, vIndexOption, SqlVersionFlags.TSql110);
...
ddlTriggerAction returns [TriggerAction vResult = FragmentFactory.CreateFragment<TriggerAction>()]
    :    
        tIdentifier:Identifier
        {
            ...
            {
                EventNotificationEventGroup eventGroupValue = TriggerEventGroupHelper.Instance.ParseOption(tIdentifier, SqlVersionFlags.TSql110);
...
systemColumn [ColumnReferenceExpression vParent]
    :
        tPseudoColumn:PseudoColumn
        {
            ...
            vParent.ColumnType = PseudoColumnHelper.Instance.ParseOption(tPseudoColumn, SqlVersionFlags.TSql110);
        }
    ;
...
class TSql110LexerInternal extends Lexer("TSqlLexerBaseInternal");
