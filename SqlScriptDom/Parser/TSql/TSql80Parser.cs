//------------------------------------------------------------------------------
// <copyright file="TSql80Parser.cs" company="Microsoft">
...
namespace Microsoft.SqlServer.TransactSql.ScriptDom
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TSql80Parser"/> class.
        /// </summary>
        ...
        TSql80ParserInternal GetNewInternalParser()
        {
            return new TSql80ParserInternal(QuotedIdentifier);
        }

        TSql80ParserInternal GetNewInternalParserForInput(TextReader input, out IList<ParseError> errors,
            int startOffset, int startLine, int startColumn)
        {
            TSql80ParserInternal parser = GetNewInternalParser();
        ...
        {
            TSql80ParserInternal parser = GetNewInternalParserForInput(input, out errors, startOffset, startLine, startColumn);
