//------------------------------------------------------------------------------
// <copyright file="TSql100.g" company="Microsoft">
...
class TSql100ParserInternal extends Parser("TSql100ParserBaseInternal");
options {
    k = 2;
...
createServerAuditStatements returns [TSqlStatement vResult]
    :    tServer:Identifier tAudit:Identifier
        {
...
alterServerConfigurationStatement returns [AlterServerConfigurationStatement vResult = FragmentFactory.CreateFragment<AlterServerConfigurationStatement>()]
    :
        tConfiguration:Identifier Set tProcess:Identifier tAffinity:Identifier
        {
...
alterDbAddFilegroup returns [AlterDatabaseAddFileGroupStatement vResult = FragmentFactory.CreateFragment<AlterDatabaseAddFileGroupStatement>()]
{
    ...
    : tFilegroup:Identifier vIdentifier=identifier 
        ...
        (Contains tFileStream:Identifier
            {
            ...
            (tUpdatabilityOption:Identifier 
                {
                    ...
                    vResult.UpdatabilityOption = ModifyFilegroupOptionsHelper.Instance.ParseOption(tUpdatabilityOption, SqlVersionFlags.TSql100);
...
dbSingleIdentOption returns [DatabaseOption vResult = FragmentFactory.CreateFragment<DatabaseOption>()]
    : tOption:Identifier
        {
            vResult.OptionKind = SimpleDbOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
            UpdateTokenInfo(vResult,tOption);
        }
    ;
...
alterDbOnOffOption returns [OnOffDatabaseOption vResult = FragmentFactory.CreateFragment<OnOffDatabaseOption>()]
{
    ...
    : tOption:Identifier vOptionState = optionOnOff[vResult]
        {
            vResult.OptionKind = OnOffSimpleDbOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
...
databaseAuditActionGroup returns [AuditActionGroupReference vResult = FragmentFactory.CreateFragment<AuditActionGroupReference>()]
    :
        ...
        {
            vResult.Group = DatabaseAuditActionGroupHelper.Instance.ParseOption(tDatabaseAuditActionGroup, SqlVersionFlags.TSql100);
...
serverAuditActionGroup returns [AuditActionGroupReference vResult = FragmentFactory.CreateFragment<AuditActionGroupReference>()]
    :
        ...
        {
            vResult.Group = ServerAuditActionGroupHelper.Instance.ParseOption(tServerAuditActionGroup, SqlVersionFlags.TSql100);
...
backupOption returns [BackupOption vResult = FragmentFactory.CreateFragment<BackupOption>()]
{
    ...
    : tSimpleOption:Identifier
        {
            ...
            vResult.OptionKind = BackupOptionsNoValueHelper.Instance.ParseOption(tSimpleOption, SqlVersionFlags.TSql100);
    ...
    | (tOption:Identifier EqualsSign 
        ...
        {
            vResult.OptionKind = BackupOptionsWithValueHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
            vResult.Value = vValue;
        }
      )
    ;
...
simpleRestoreOption returns [RestoreOption vResult = FragmentFactory.CreateFragment<RestoreOption>()]
    : tOption:Identifier
        {
            vResult.OptionKind = RestoreOptionNoValueHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
            UpdateTokenInfo(vResult,tOption);
        }
    ;
...
simpleBulkInsertOptionWithValue returns [LiteralBulkInsertOption vResult = FragmentFactory.CreateFragment<LiteralBulkInsertOption>()]
{
    ...
    : tOption:Identifier EqualsSign 
        ...
        | vValue = stringLiteral
            {
                vResult.OptionKind = BulkInsertStringOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
                UpdateTokenInfo(vResult, tOption);
...
dbccOption returns [DbccOption vResult=FragmentFactory.CreateFragment<DbccOption>()]
    :     tOption:Identifier 
        {
            vResult.OptionKind= DbccOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
            UpdateTokenInfo(vResult, tOption);
        }
    ;
...
eventTypeGroupContainer returns [EventTypeGroupContainer vResult = null]
    : 
        tIdentifier:Identifier
        {
            ...
            if (TriggerEventTypeHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql100, out eventTypeValue))
            {
                vResult = CreateEventTypeContainer(eventTypeValue, tIdentifier);
            }
            else if (AuditEventTypeHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql100, out eventTypeValue))
            {
                vResult = CreateEventTypeContainer(eventTypeValue, tIdentifier);
            }
            else if (TriggerEventGroupHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql100, out eventGroupValue))
            {
                vResult = CreateEventGroupContainer(eventGroupValue, tIdentifier);
            }
            else
            {
                eventGroupValue = AuditEventGroupHelper.Instance.ParseOption(tIdentifier, SqlVersionFlags.TSql100);
                vResult = CreateEventGroupContainer(eventGroupValue, tIdentifier);
            }
        }
    ;
...
createFulltextOptionsList [CreateFullTextIndexStatement vParent]
{
    ...
    :   (
            (   
                vOption = changeTrackingFulltextIndexOption
                {
                    AddAndUpdateTokenInfo(vParent, vParent.Options, vOption);
                }
                (Comma vOption = stoplistFulltextIndexOption
                    {
                        AddAndUpdateTokenInfo(vParent, vParent.Options, vOption);
                    }
                )?
        ...
        |
            (
                ...
                (Comma vOption = changeTrackingFulltextIndexOption
                    {
                        AddAndUpdateTokenInfo(vParent, vParent.Options, vOption);
                    }
                )?
...
setStoplistAlterFulltextIndexAction returns [SetStopListAlterFullTextIndexAction vResult = FragmentFactory.CreateFragment<SetStopListAlterFullTextIndexAction>()]
{
    ...
    :   tSet:Set vOption = stoplistFulltextIndexOption
        {
...
setChangeTrackingAlterFulltextIndexAction returns [SimpleAlterFullTextIndexAction vResult = FragmentFactory.CreateFragment<SimpleAlterFullTextIndexAction>()]
    : Set tChangeTracking:Identifier (EqualsSign)?
        {
            Match(tChangeTracking, CodeGenerationSupporter.ChangeTracking);
        }
        (
...
alterIndexStatement returns [AlterIndexStatement vResult = this.FragmentFactory.CreateFragment<AlterIndexStatement>()]
{
    ...
    : Index 
        ...
        |
            ...
            {
                vResult.AlterIndexType = AlterIndexTypeHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
                UpdateTokenInfo(vResult,tOption);
            }
            (
...
userOption returns [IdentifierPrincipalOption vResult = FragmentFactory.CreateFragment<IdentifierPrincipalOption>()]
{
    ...
    :   tOption:Identifier EqualsSign vIdentifier=identifier
        {
            vResult.OptionKind = UserOptionHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
            vResult.Identifier = vIdentifier;
        }
    ;
...
{
    Identifier vIdentifier;
    IdentifierPrincipalOption vUserOption;
}
    :   User vIdentifier = identifier
        {
            vResult.Name = vIdentifier;
...
predicateSetStatement returns [PredicateSetStatement vResult = this.FragmentFactory.CreateFragment<PredicateSetStatement>()]
{
    ...
    : tOption:Identifier 
        {
            option = PredicateSetOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
                
            vResult.Options = option;
        }
        (Comma tOption2:Identifier
            {
                option = PredicateSetOptionsHelper.Instance.ParseOption(tOption2, SqlVersionFlags.TSql100);
...
setStatisticsStatement returns [SetStatisticsStatement vResult = FragmentFactory.CreateFragment<SetStatisticsStatement>()]
    : Statistics tStatOption:Identifier 
        {
            vResult.Options = SetStatisticsOptionsHelper.Instance.ParseOption(tStatOption, SqlVersionFlags.TSql100);
        }
        (Comma tStatOption2:Identifier
            {
                vResult.Options |= SetStatisticsOptionsHelper.Instance.ParseOption(tStatOption2, SqlVersionFlags.TSql100);
            }
        )* 
        setOnOff[vResult]
    ;
...
createIndexStatement returns [CreateIndexStatement vResult = FragmentFactory.CreateFragment<CreateIndexStatement>()]
{
    Identifier vIdentifier;
    SchemaObjectName vSchemaObjectName;
...
indexStateOption returns [IndexStateOption vResult = FragmentFactory.CreateFragment<IndexStateOption>()]
{
    ...
    :    tOption:Identifier 
        {
            vResult.OptionKind = IndexOptionHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql100);
            UpdateTokenInfo(vResult, tOption);
        }
        EqualsSign vOptionState=optionOnOff[vResult]
        {
...
simpleTableHint returns [TableHint vResult = FragmentFactory.CreateFragment<TableHint>()]
    ...
    |   tId:Identifier
        {
            vResult.HintKind = TableHintOptionsHelper.Instance.ParseOption(tId, SqlVersionFlags.TSql100);
            UpdateTokenInfo(vResult,tId);
        }
    ;
...
literalOptimizerHint returns [LiteralOptimizerHint vResult = FragmentFactory.CreateFragment<LiteralOptimizerHint>()]
{
    ...
    : tIntegerHint:Identifier vValue = integer
        {
            vResult.HintKind = IntegerOptimizerHintHelper.Instance.ParseOption(tIntegerHint, SqlVersionFlags.TSql100);
            vResult.Value = vValue;
        }
    ;
...
resourcePoolParameter returns [ResourcePoolParameter vResult = this.FragmentFactory.CreateFragment<ResourcePoolParameter>()]
{
    Literal vPercent;
        ...
        : tPercent:Identifier 
        {
            vResult.ParameterType = ResourcePoolParameterHelper.Instance.ParseOption(tPercent, SqlVersionFlags.TSql100);            
        }
            ...
            tParameter:Identifier EqualsSign 
                ...
                |
                    vParameter=integer
                    {
                        ...
                        workloadGroupResource.ParameterType = WorkloadGroupResourceParameterHelper.Instance.ParseOption(tParameter, SqlVersionFlags.TSql100);
                        Int32 value;
...
spatialIndexingScheme [CreateSpatialIndexStatement vParent]
    :    tUsing:Identifier 
        ...
        {
            vParent.SpatialIndexingScheme = SpatialIndexingSchemeTypeHelper.Instance.ParseOption(tIndexingScheme, SqlVersionFlags.TSql100);            
...
ddlTriggerAction returns [TriggerAction vResult = FragmentFactory.CreateFragment<TriggerAction>()]
    :    
        tIdentifier:Identifier
        {
            ...
            {
                EventNotificationEventGroup eventGroupValue = TriggerEventGroupHelper.Instance.ParseOption(tIdentifier, SqlVersionFlags.TSql100);
...
withDataCompression [CreateTableStatement vParent]
{
    TableDataCompressionOption vOption;
}
    : With LeftParenthesis vOption = tableDataCompressionOption
        {
            AddAndUpdateTokenInfo(vParent, vParent.Options, vOption);
        }
        (Comma vOption = tableDataCompressionOption
            {
                AddAndUpdateTokenInfo(vParent, vParent.Options, vOption);
            }
        )*
...
systemColumn [ColumnReferenceExpression vParent]
    :
        tPseudoColumn:PseudoColumn
        {
            ...
            vParent.ColumnType = PseudoColumnHelper.Instance.ParseOption(tPseudoColumn, SqlVersionFlags.TSql100);
        }
    ;
...
class TSql100LexerInternal extends Lexer("TSqlLexerBaseInternal");
