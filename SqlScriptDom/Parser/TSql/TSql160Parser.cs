//------------------------------------------------------------------------------
// <copyright file="TSql160Parser.cs" company="Microsoft">
...
namespace Microsoft.SqlServer.TransactSql.ScriptDom
{
    ...
    public class TSql160Parser : TSqlParser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TSql160Parser"/> class.
        /// </summary>
        /// <param name="initialQuotedIdentifiers">if set to <c>true</c> [initial quoted identifiers].</param>
        public TSql160Parser(bool initialQuotedIdentifiers)
        ...
        public TSql160Parser(bool initialQuotedIdentifiers, SqlEngineType engineType)
            : base(initialQuotedIdentifiers)
        {
        ...
        {
            return new TSql160LexerInternal();
        }

        #region Some utility stuff
        TSql160ParserInternal GetNewInternalParser()
        {
            return new TSql160ParserInternal(QuotedIdentifier);
        }

        TSql160ParserInternal GetNewInternalParserForInput(TextReader input, out IList<ParseError> errors, 
            int startOffset, int startLine, int startColumn)
        {
            TSql160ParserInternal parser = GetNewInternalParser();
        ...
        public override TSqlFragment Parse(IList<TSqlParserToken> tokens, out IList<ParseError> errors)
        {
            ...
            if (result != null)
            {
                VersioningVisitor versioningVisitor = new VersioningVisitor(engineType, SqlVersion.Sql160);
        ...
        {
            TSql160ParserInternal parser = GetNewInternalParserForInput(input, out errors, startOffset, startLine, startColumn);
