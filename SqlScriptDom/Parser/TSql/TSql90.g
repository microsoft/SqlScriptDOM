//------------------------------------------------------------------------------
// <copyright file="TSql90.g" company="Microsoft">
...
class TSql90ParserInternal extends Parser("TSql90ParserBaseInternal");
options {
    k = 2;
...
createAggregateStatement returns [CreateAggregateStatement vResult = FragmentFactory.CreateFragment<CreateAggregateStatement>()]
{
    ...
    : tAggregate:Identifier vSchemaObjectName=schemaObjectThreePartName
        ...
        LeftParenthesis vParameter = aggregateParameter RightParenthesis
        {
...
aggregateParameter returns [ProcedureParameter vResult = FragmentFactory.CreateFragment<ProcedureParameter>()]
{
    ...
    :   vParamName = identifierVariable vDataType = scalarDataType
        {
            ...
            (tUpdatabilityOption:Identifier 
                {
                    ...
                    vResult.UpdatabilityOption = ModifyFilegroupOptionsHelper.Instance.ParseOption(tUpdatabilityOption, SqlVersionFlags.TSql90);
...
dbSingleIdentOption returns [DatabaseOption vResult = FragmentFactory.CreateFragment<DatabaseOption>()]
    : tOption:Identifier
        {
            vResult.OptionKind = SimpleDbOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
...
alterDbOnOffOption returns [OnOffDatabaseOption vResult = FragmentFactory.CreateFragment<OnOffDatabaseOption>()]
{
    ...
    : tOption:Identifier vOptionState = optionOnOff[vResult]
        {
            vResult.OptionKind = OnOffSimpleDbOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
...
dbAddendums [CreateDatabaseStatement vParent]
{
    ...
    : (For tAttach:Identifier 
        ...
        // Greedy due to conflict with identifierStatements. And, this Identifier is ignored in SQL server...
        (options {greedy=true;} : Identifier)?
      )
...
withTrustOptionsOnOff [CreateDatabaseStatement vParent]
 {
    DatabaseOption vOption;
    long encounteredOptions = 0;
}
    : 
    With vOption = createDbOption 
        {
            CheckOptionDuplication(ref encounteredOptions, (int)vOption.OptionKind, vOption);
            AddAndUpdateTokenInfo(vParent, vParent.Options, vOption);
        }
        (Comma vOption = createDbOption
            {
                CheckOptionDuplication(ref encounteredOptions, (int)vOption.OptionKind, vOption);
                AddAndUpdateTokenInfo(vParent, vParent.Options, vOption);
            }
...
createDbOption returns [DatabaseOption vResult]
    :
...
backupOption returns [BackupOption vResult = FragmentFactory.CreateFragment<BackupOption>()]
{
    ...
    : tSimpleOption:Identifier
        {
            vResult.OptionKind = BackupOptionsNoValueHelper.Instance.ParseOption(tSimpleOption, SqlVersionFlags.TSql90);
    ...
    | (tOption:Identifier EqualsSign 
        ...
        {
            vResult.OptionKind = BackupOptionsWithValueHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
            vResult.Value = vValue;
        }
      )
    ;
...
simpleRestoreOption returns [RestoreOption vResult = FragmentFactory.CreateFragment<RestoreOption>()]
    : tOption:Identifier
        {
            vResult.OptionKind = RestoreOptionNoValueHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
            UpdateTokenInfo(vResult,tOption);
        }
    ;
...
// Dump/Backup and Load/Restore SERVICE MASTER Key statements
...
// Dump/Backup and Load/Restore MASTER Key statements
...
simpleBulkInsertOptionWithValue returns [LiteralBulkInsertOption vResult = FragmentFactory.CreateFragment<LiteralBulkInsertOption>()]
{
    ...
    : tOption:Identifier EqualsSign 
        ...
        | vValue = stringLiteral
            {
                vResult.OptionKind = BulkInsertStringOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
                UpdateTokenInfo(vResult, tOption);
...
dbccOption returns [DbccOption vResult=FragmentFactory.CreateFragment<DbccOption>()]
    :     tOption:Identifier 
        {
            vResult.OptionKind= DbccOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
            UpdateTokenInfo(vResult, tOption);
        }
    ;
...
createEventNotificationStatement returns [CreateEventNotificationStatement vResult = this.FragmentFactory.CreateFragment<CreateEventNotificationStatement>()]
{
    ...
    : tEvent:Identifier tNotification:Identifier vIdentifier=identifier
        {
...
eventTypeGroupContainer returns [EventTypeGroupContainer vResult = null]
    : 
        tIdentifier:Identifier
        {
            ...
            if (TriggerEventTypeHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql90, out eventTypeValue))
            {
                vResult = CreateEventTypeContainer(eventTypeValue, tIdentifier);
            }
            else if (AuditEventTypeHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql90, out eventTypeValue))
            {
                vResult = CreateEventTypeContainer(eventTypeValue, tIdentifier);
            }
            else if (TriggerEventGroupHelper.Instance.TryParseOption(tIdentifier, SqlVersionFlags.TSql90, out eventGroupValue))
            {
                vResult = CreateEventGroupContainer(eventGroupValue, tIdentifier);
            }
            else
            {
                eventGroupValue = AuditEventGroupHelper.Instance.ParseOption(tIdentifier, SqlVersionFlags.TSql90);
                vResult = CreateEventGroupContainer(eventGroupValue, tIdentifier);
            }
        }
    ;
...
createFulltextIndexStatement returns [CreateFullTextIndexStatement vResult = this.FragmentFactory.CreateFragment<CreateFullTextIndexStatement>()]
{
    ...
    ChangeTrackingFullTextIndexOption vOption;
}
    :   Index On vObjectName=schemaObjectFourPartName
        ...
        (
            LeftParenthesis
            vFulltextIndexColumn=fulltextIndexColumn
            {
        ...
        (
            // Greedy due to conflict with withCommonTableExpressionsAndXmlNamespaces
            options {greedy = true; } :
            With vOption = fulltextChangeTrackingOption
            {
                AddAndUpdateTokenInfo(vResult, vResult.Options, vOption);
            }
        )?
...
fulltextChangeTrackingOption returns [ChangeTrackingFullTextIndexOption vResult = FragmentFactory.CreateFragment<ChangeTrackingFullTextIndexOption>()]
    :
...
fullTextCatalogAndFileGroup returns [FullTextCatalogAndFileGroup vResult = FragmentFactory.CreateFragment<FullTextCatalogAndFileGroup>()]
{
    ...
    :   tOn:On vCatalogName=identifier
        {
...
createPrimaryXmlIndexStatement returns [CreateXmlIndexStatement vResult = null]
...
createXmlIndexStatement[bool vPrimary] returns [CreateXmlIndexStatement vResult = this.FragmentFactory.CreateFragment<CreateXmlIndexStatement>()]
{
    vResult.Primary = vPrimary;
    Identifier vIdentifier;
    SchemaObjectName vSchemaObjectName;
}
    :
        ...
        |   tUsing:Identifier 
            ...
            vIdentifier=identifier
            {
                vResult.SecondaryXmlIndexName = vIdentifier;
            }
            (
...
createRoleStatement returns [CreateRoleStatement vResult = this.FragmentFactory.CreateFragment<CreateRoleStatement>()]
{
    ...
    : 
        ...
        (
            Authorization vIdentifier=identifier
            {
                vResult.Owner = vIdentifier;            
            }            
        )?
    ;
...
createUserStatement returns [CreateUserStatement vResult = this.FragmentFactory.CreateFragment<CreateUserStatement>()]
{
    ...
    : 
        ...
        createUserDefaultSchemaOpt[vResult]
    ;

createUserDefaultSchemaOpt [CreateUserStatement vParent]
{
    Identifier vIdentifier;
}
    :   (   // Greedy due to conflict with withCommonTableExpressionsAndXmlNamespaces
            options {greedy = true; } :
            With tDefaultSchema:Identifier EqualsSign vIdentifier=identifier 
            {
                Match(tDefaultSchema, CodeGenerationSupporter.DefaultSchema);
                IdentifierPrincipalOption userOption = FragmentFactory.CreateFragment<IdentifierPrincipalOption>();
                userOption.OptionKind = PrincipalOptionKind.DefaultSchema;
                userOption.Identifier = vIdentifier;
                AddAndUpdateTokenInfo(vParent, vParent.UserOptions, userOption);
            }
        )?
    ;
...
applicationRoleOption[bool defaultSchemaAndPasswordOnly] returns [ApplicationRoleOption vResult = FragmentFactory.CreateFragment<ApplicationRoleOption>()]
{
    Literal vLiteral;
    Identifier vIdentifier;
}
...
setChangeTrackingAlterFulltextIndexAction returns [SimpleAlterFullTextIndexAction vResult = FragmentFactory.CreateFragment<SimpleAlterFullTextIndexAction>()]
    : Set tChangeTracking:Identifier
        {
            Match(tChangeTracking, CodeGenerationSupporter.ChangeTracking);
        }
        (
...
alterIndexStatement returns [AlterIndexStatement vResult = this.FragmentFactory.CreateFragment<AlterIndexStatement>()]
{
    ...
    : Index 
        ...
        |
            tOption:Identifier
            {
                vResult.AlterIndexType = AlterIndexTypeHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
                UpdateTokenInfo(vResult,tOption);
            }
            (
...
partitionSpecifier returns [PartitionSpecifier vResult = FragmentFactory.CreateFragment<PartitionSpecifier>()]
{
    ...
    :    tPartition:Identifier EqualsSign vExpression = expression
        {
            Match(tPartition, CodeGenerationSupporter.Partition);
...
alterPartitionFunctionStatement returns [AlterPartitionFunctionStatement vResult = FragmentFactory.CreateFragment<AlterPartitionFunctionStatement>()]
{
    ...
    : Function vIdentifier = identifier LeftParenthesis RightParenthesis
        ...
        tSplitMerge:Identifier 
            {
                if (TryMatch(tSplitMerge,CodeGenerationSupporter.Split))
                    vResult.IsSplit = true;
                else
                {
                    Match(tSplitMerge,CodeGenerationSupporter.Merge);
                    vResult.IsSplit = false;
                }
                UpdateTokenInfo(vResult,tSplitMerge);
            }
        (    options {greedy = true; } : // Greedy due to conflict with identifierStatements
...
alterRoleStatement returns [AlterRoleStatement vResult = this.FragmentFactory.CreateFragment<AlterRoleStatement>()]
{
    ...
    :     tRole:Identifier vIdentifier=identifier
        ...
        vAlterRoleAction=renameAlterRoleAction
        {
...
userOption returns [IdentifierPrincipalOption vResult = FragmentFactory.CreateFragment<IdentifierPrincipalOption>()]
{
    Identifier vIdentifier;
}
    :   tOption:Identifier EqualsSign vIdentifier=identifier
        {
            UpdateTokenInfo(vResult, tOption);
            vResult.OptionKind = UserOptionHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
            vResult.Identifier = vIdentifier;
        }
    ;
...
functionReturnTypeAndBody [FunctionStatementBody vParent, out bool vParseErrorOccurred]
{
    ...
    | 
        ...
        (functionAttributes[vParent])? (As)? vMethodSpecifier = methodSpecifier optSemicolons[vParent]
        {
            vParent.MethodSpecifier = vMethodSpecifier;
        }
    ;
...
functionReturnClauseRelational returns [SelectFunctionReturnType vResult = FragmentFactory.CreateFragment<SelectFunctionReturnType>()]
{
    ...
    | tLParen:LeftParenthesis vWithCTEAndXmlNamespaces=withCommonTableExpressionsAndXmlNamespaces vSubqueryExpression = subqueryExpression tRParen:RightParenthesis
        {
            UpdateTokenInfo(vResult,tLParen);
...
functionExecuteAsOption returns [ExecuteAsFunctionOption vResult=FragmentFactory.CreateFragment<ExecuteAsFunctionOption>()]
{
    ...
    :
        vExecuteAs=executeAsClause[false, false]
        {
            ...
            /*if (vParent.ExecuteAs != null)
                ThrowParseErrorException("SQL46034", vExecuteAs, TSqlParserResource.SQL46034Message);*/
...
updateStatisticsStatement returns [UpdateStatisticsStatement vResult = this.FragmentFactory.CreateFragment<UpdateStatisticsStatement>()]
{
    ...
    :   tUpdate:Update Statistics vSchemaObjectName=schemaObjectThreePartName
        {
...
grantStatement90 returns [GrantStatement vResult = this.FragmentFactory.CreateFragment<GrantStatement>()]
{
...
denyStatement90 returns [DenyStatement vResult = this.FragmentFactory.CreateFragment<DenyStatement>()]
{
    bool vPermissionContainsColumns = false;
}
    :    tDeny:Deny 
...
securityStatementTargetObjectOpt[SecurityStatement vParent, bool vPermissionContainsColumns]
{
    SecurityTargetObject vSecurityTargetObject;
}
    :    (vSecurityTargetObject=securityTargetObject[vPermissionContainsColumns]
            {
...
dropEventNotificationStatement returns [DropEventNotificationStatement vResult = FragmentFactory.CreateFragment<DropEventNotificationStatement>()]
{
    ...
    : tEvent:Identifier tNotification:Identifier vEventNotification = identifier
        {
            Match(tEvent,CodeGenerationSupporter.Event);
            Match(tNotification,CodeGenerationSupporter.Notification);
...
predicateSetStatement returns [PredicateSetStatement vResult = this.FragmentFactory.CreateFragment<PredicateSetStatement>()]
    : tOption:Identifier 
        {
            vResult.Options = PredicateSetOptionsHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
        }
        (Comma tOption2:Identifier
            {
                vResult.Options |= PredicateSetOptionsHelper.Instance.ParseOption(tOption2, SqlVersionFlags.TSql90);
            }
        )* 
        setOnOff[vResult]
        {
...
setStatisticsStatement returns [SetStatisticsStatement vResult = FragmentFactory.CreateFragment<SetStatisticsStatement>()]
    : Statistics tStatOption:Identifier 
        {
            vResult.Options = SetStatisticsOptionsHelper.Instance.ParseOption(tStatOption, SqlVersionFlags.TSql90);
        }
        (Comma tStatOption2:Identifier
            {
                vResult.Options |= SetStatisticsOptionsHelper.Instance.ParseOption(tStatOption2, SqlVersionFlags.TSql90);
            }
        )* 
        setOnOff[vResult]
    ;
...
createIndexStatement returns [CreateIndexStatement vResult = this.FragmentFactory.CreateFragment<CreateIndexStatement>()]
{
    ...
    : tCreate:Create 
        ...
        (
            ...
            tInclude:Identifier identifierColumnList[vResult, vResult.IncludeColumns]
        )?
        (
            // Greedy due to conflict with withCommonTableExpressionsAndXmlNamespaces
            options {greedy = true; } :
...
fillFactorOption returns [IndexExpressionOption vResult = FragmentFactory.CreateFragment<IndexExpressionOption>()]
{
    Literal vValue;
}    
...
indexOptionList[IndexAffectingStatement statement, IList<IndexOption> optionsList, TSqlFragment vParent]
{
    ...
    :
        ...
        {
            VerifyAllowedIndexOption(statement, vIndexOption);
            AddAndUpdateTokenInfo(vParent, optionsList, vIndexOption);
        }
        (
...
onlineIndexOption returns [IndexStateOption vResult = this.FragmentFactory.CreateFragment<IndexStateOption>()]
{
    OptionState vOptionState;
}
    :    tOption:Identifier 
...
indexStateOption returns [IndexStateOption vResult = this.FragmentFactory.CreateFragment<IndexStateOption>()]
{
    OptionState vOptionState;
}
    :    tOption:Identifier 
        {
            vResult.OptionKind = IndexOptionHelper.Instance.ParseOption(tOption, SqlVersionFlags.TSql90);
            UpdateTokenInfo(vResult, tOption);
        }
        EqualsSign vOptionState=optionOnOff[vResult]
        {
...
commonTableExpression returns [CommonTableExpression vResult = this.FragmentFactory.CreateFragment<CommonTableExpression>()]
{
    ...
    :   vIdentifier=identifier
        ...
        (columnNameList[vResult, vResult.Columns])?
        As tLParen:LeftParenthesis vQueryExpression=subqueryExpression tRParen:RightParenthesis
        {
...
xmlNamespaces returns [XmlNamespaces vResult = this.FragmentFactory.CreateFragment<XmlNamespaces>()]
{
    ...
    :
        ...
        LeftParenthesis
        vXmlNamespacesElement=xmlNamespacesElement
        {
...
subqueryParenthesis returns [QueryParenthesisExpression vResult = FragmentFactory.CreateFragment<QueryParenthesisExpression>()]
{
    QueryExpression vQueryExpression;
}
    :   tLParen:LeftParenthesis vQueryExpression=subqueryExpression tRParen:RightParenthesis
...
queryParenthesis[SelectStatement vSelectStatement] returns [QueryParenthesisExpression vResult = this.FragmentFactory.CreateFragment<QueryParenthesisExpression>()]
{
    ...
    :   tLParen:LeftParenthesis vQueryExpression=queryExpression[vSelectStatement] tRParen:RightParenthesis
        {
            UpdateTokenInfo(vResult,tLParen);
            vResult.QueryExpression = vQueryExpression;
            UpdateTokenInfo(vResult,tRParen);
    ...
    :    tSelect:Select
        ...
        )?
        {
            if (vResult.OrderByClause != null && 
                vResult.TopRowFilter == null && vResult.ForClause == null)
            {
...
querySpecification[SelectStatement vSelectStatement] returns [QuerySpecification vResult = this.FragmentFactory.CreateFragment<QuerySpecification>()]
{
    ...
    :   tSelect:Select
        ...
        (
            tInto:Into vSchemaObjectName=schemaObjectThreePartName
            {
...
topRowFilter returns [TopRowFilter vResult = this.FragmentFactory.CreateFragment<TopRowFilter>()]
{
    ...
    :
        ...
        |
            vExpression=paranthesisDisambiguatorForExpressions[ExpressionFlags.None]
        )
        {
            vResult.Expression = vExpression;
        }
...
// This rule corresponds to insupddel_topn in Sql Server grammar.
topRowFilterForInsertUpdateDelete returns [TopRowFilter vResult = this.FragmentFactory.CreateFragment<TopRowFilter>()]
{
    ScalarExpression vExpression;
}
    :
...
selectTableReference returns [TableReference vResult = null]
    :
        ...
        (
            selectTableReferenceAdditionalElement[ref vResult]
        )*
    ;
...
selectTableReferenceAdditionalElement[ref TableReference vResult]
    :
        joinElement[ref vResult]
    |
...
{        
    ...
    :   tDelete:Delete
        ...
        (
            vTopRowFilter=topRowFilterForInsertUpdateDelete
            {
                vResult.TopRowFilter = vTopRowFilter;
            }
        )?
        ...
        (
            {NextTokenMatches(CodeGenerationSupporter.Output)}?
            outputIntoOutputClause[vResult]
        )?
        vFromClause = fromClauseOpt
        {
            vResult.FromClause = vFromClause;
...
setClauseStartingWithVariable returns [AssignmentSetClause vResult = FragmentFactory.CreateFragment<AssignmentSetClause>()]
{
    ...
    :   vLiteral=variable EqualsSign
        ...
        (
            (multiPartIdentifier[-1] EqualsSign)=>
            vMultiPartIdentifier=multiPartIdentifier[-1] EqualsSign vExpression=expressionWithDefault
            {
...
simpleTableHint returns [TableHint vResult = FragmentFactory.CreateFragment<TableHint>()]
    ...
    |   tId:Identifier
        {
            vResult.HintKind = TableHintOptionsHelper.Instance.ParseOption(tId, SqlVersionFlags.TSql90);
            UpdateTokenInfo(vResult,tId);
        }
    ;
...
simpleOptimizerHint returns [OptimizerHint vResult = FragmentFactory.CreateFragment<OptimizerHint>()]
    ...
    | tPlan:Identifier Plan
        {
            vResult.HintKind = PlanOptimizerHintHelper.Instance.ParseOption(tPlan, SqlVersionFlags.TSql90);
        }
...
literalOptimizerHint returns [LiteralOptimizerHint vResult = FragmentFactory.CreateFragment<LiteralOptimizerHint>()]
{
    ...
    : tIntegerHint:Identifier vValue = integer
        {
            vResult.HintKind = IntegerOptimizerHintHelper.Instance.ParseOption(tIntegerHint, SqlVersionFlags.TSql90);
            vResult.Value = vValue;
        }
    ;
...
optimizeForOptimizerHint returns [OptimizeForOptimizerHint vResult = FragmentFactory.CreateFragment<OptimizeForOptimizerHint>()]
{
    ...
    : tOptimize:Identifier For LeftParenthesis vPair = variableValuePair 
        {
...
variableValuePair returns [VariableValuePair vResult = FragmentFactory.CreateFragment<VariableValuePair>()]
{
    ...
    : vVariable = variable EqualsSign vLiteral = literal
        {
            vResult.Variable = vVariable;
...
ddlTriggerAction returns [TriggerAction vResult = FragmentFactory.CreateFragment<TriggerAction>()]
    :    
        tIdentifier:Identifier
        {
            ...
            {
                EventNotificationEventGroup eventGroupValue = TriggerEventGroupHelper.Instance.ParseOption(tIdentifier, SqlVersionFlags.TSql90);
    ...
    : tStar:Star
        {
            ...
            vColumn.ColumnType = ColumnType.Wildcard;
            UpdateTokenInfo(vColumn, tStar);
...
sendStatement returns [SendStatement vResult = FragmentFactory.CreateFragment<SendStatement>()]
{
    ...
    : tSend:Identifier On tConversation:Identifier vExpression = expression
        {
    ...
    :
        ...
        |   
            ...
            |
                ...
                {
                    Match(tPersisted, CodeGenerationSupporter.Persisted);
                    UpdateTokenInfo(vResult,tPersisted);
                    if (vAddDefined)
                        vResult.AlterTableAlterColumnOption = AlterTableAlterColumnOption.AddPersisted;
                    else
                        vResult.AlterTableAlterColumnOption = AlterTableAlterColumnOption.DropPersisted;
                }
            )
        )
    ;
...
alterTableDropTableElementWithOptions[AlterTableDropTableElement vParent]
{
    ...
    :    With LeftParenthesis vDropClusteredConstraintOption=dropClusteredConstraintOption
        {
    ...
    : vIdentifier=identifier
        {
            ...
            // other places, because we have to add the column 
...
uniqueColumnConstraint [IndexAffectingStatement statementType] returns [UniqueConstraintDefinition vResult = this.FragmentFactory.CreateFragment<UniqueConstraintDefinition>()]
{
    ColumnWithSortOrder vColumnWithSortOrder;
}
    :
    ...
    : 
        (
            vName=dataTypeSchemaObjectName
            {
                ...
                {
                    typeOption = ParseDataType(vName.BaseIdentifier.Value);
...
sqlDataTypeWithNational returns [SqlDataTypeReference vResult = FragmentFactory.CreateFragment<SqlDataTypeReference>()]
{
   ...
   :    tNational:National vName=dataTypeSchemaObjectName
        {
            vResult.SqlDataTypeOption = ParseDataType(vName.BaseIdentifier.Value);
...
schemaObjectFourPartName returns [SchemaObjectName vResult = this.FragmentFactory.CreateFragment<SchemaObjectName>()]
{
    ...
    :
        ...
        {
            foreach(Identifier identifier in vIdentifierList)
            {
                AddAndUpdateTokenInfo(vResult, vResult.Identifiers, identifier);
            }
        }
    ;
...
booleanExpressionPrimary [ExpressionFlags expressionFlags] returns [BooleanExpression vResult = null]
{
    ...
    |   
        ...
        |   
            // This is here for 80 compat mode (there was a QFE), logically not needed
...
joinPredicate[ScalarExpression vExpressionFirst, BooleanComparisonType vType, ExpressionFlags expressionFlags] returns [BooleanComparisonExpression vResult = this.FragmentFactory.CreateFragment<BooleanComparisonExpression>()]
{
    ...
    :
        vType=joinOperator vExpressionSecond=expressionWithFlags[expressionFlags]
        {
...
// NOTE, olegr: The following rule exists to avoid NullRef exception with vFunctionCall in predicate checking mode    
...
aggregateBuiltInFunctionCall [FunctionCall vParent]
{
    ...
    :    vUniqueRowFilter=uniqueRowFilter[out distinctToken] vExpression=expression tRParen:RightParenthesis
        {
            vParent.UniqueRowFilter = vUniqueRowFilter;
...
specialColumn[ColumnReferenceExpression vResult]
    ...
    |
        tPseudoColumn:PseudoColumn
        {
            ...
            vResult.ColumnType = PseudoColumnHelper.Instance.ParseOption(tPseudoColumn, SqlVersionFlags.TSql90);
        }
    ;
...
userFunctionCall[MultiPartIdentifier vIdentifiers] returns [FunctionCall vResult = FragmentFactory.CreateFragment<FunctionCall>()]
{
    ...
    :   LeftParenthesis
        ...
        |
            vUniqueRowFilter=uniqueRowFilter[out distinctToken] vExpression=expression
            {
...
class TSql90LexerInternal extends Lexer("TSqlLexerBaseInternal");
